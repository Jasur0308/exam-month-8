      ...
      <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0">
        ...
        <div className="mt-8 flex space-x-4">
          <a
            ...
            className="bg-black text-white px-6 py-3 rounded hover:opacity-70 transition flex items-center"
          >
            <ShoppingCartIcon className="h-5 w-5 mr-2" />
            Buy Now
          </a>
          <button
            className="border border-pink-600 text-black px-6 py-3 rounded hover:bg-black hover:text-white transition" 
